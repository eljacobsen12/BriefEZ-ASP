<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="11 SubArguments.aspx.vb" Inherits="BriefEZ._11_SubArguments" %>
...
<body style="text-align: center">
    ...
    <div style="background-color: #999999">
        ...
        <br />
        <asp:Label ID="lblArgument" runat="server" Font-Names="Lucida Bright" Font-Size="XX-Large" Font-Underline="False" Text="Argument"></asp:Label>
        &nbsp;<asp:Label ID="lblArgumentNum" runat="server" Font-Names="Lucida Bright" Font-Size="XX-Large" Font-Underline="False" Text="1"></asp:Label>
        <br />
        <asp:Label ID="lblSubArguments" runat="server" Font-Names="Lucida Bright" Font-Size="X-Large" Font-Underline="False" Text="SubArguments"></asp:Label>
        <br />
