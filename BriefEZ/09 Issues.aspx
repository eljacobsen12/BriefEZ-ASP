<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="09 Issues.aspx.vb" Inherits="BriefEZ.Issues" %>
...
<body style="text-align: center">
    <form id="IssuesForm" runat="server">
    <div id="Header" style="background-color: #999999">
        ...
        <br />
        <asp:Label ID="lblIssues" runat="server" Font-Names="Lucida Bright" Font-Size="XX-Large" Font-Underline="False" Text="Issues"></asp:Label>
        <br />
